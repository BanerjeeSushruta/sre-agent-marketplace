...
# Rules AZFO-008, 017, 018, 019, 024 require account/subscription-scope data
# (load balancer telemetry, budgets, Advisor feed, subscription offer type,
# export inventory) rather than a single resource record. They are reported
# as "not evaluated - requires additional data" so the report still lists
# them for manual follow-up. See references/finops_rules.json for their
# detection_logic and remediation guidance.
